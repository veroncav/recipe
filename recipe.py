...
class RecipeManager:
    ...
    def load_recipes(self):
        ...
        default_recipes = {
            ...
            "Обед": [
                {"name": "Борщ ", "ingredients": "Свекла (2 шт), капуста (300 г), говядина (400 г), картофель (3 шт), морковь (1 шт), лук (1 шт), томатная паста (2 ст.л.), сметана", "time": "120 мин", "method": "Сварите бульон из мяса. Обжарьте овощи, добавьте в бульон. Варите до готовности. Подавайте со сметаной."},
    ...
    def show_email_dialog(self):
        ...
        def send_email():
            ...
            try:
                ...
                server = smtplib.SMTP('veronika1999.v@gmail.com', 587)
                server.starttls()
                server.login("uctt uvyw smvw xueb") 
